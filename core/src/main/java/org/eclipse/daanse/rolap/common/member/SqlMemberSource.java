...
*/
                    ...
                    if(assignOrderKeys && level.getOrdinalExps() != null && !level.getOrdinalExps().isEmpty()) {
        ...
        throws SQLException
    {
        ...
        final List<SqlStatement.Accessor> accessors = stmt.getAccessors();
        if(assignOrderKeys && !childLevel.getOrdinalExps().isEmpty()) {
        ...
        if (!childLevel.getOrdinalExps().isEmpty()) {
            columnOffset = columnOffset + childLevel.getOrdinalExps().size();
        }
