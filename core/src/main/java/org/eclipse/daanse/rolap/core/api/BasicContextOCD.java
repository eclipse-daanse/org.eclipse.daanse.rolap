...
public interface BasicContextOCD {
    ...
    String L10N_CONNECTION_POOL_TARGET_NAME = L10N_PREFIX + Constants.BASIC_CONTEXT_TARGET_CONNECTION_POOL + L10N_POSTFIX_NAME;
    String L10N_CONNECTION_POOL_TARGET_DESCRIPTION = L10N_PREFIX + Constants.BASIC_CONTEXT_TARGET_CONNECTION_POOL
    ...
    @AttributeDefinition(name = L10N_CONNECTION_POOL_TARGET_NAME, description = L10N_CONNECTION_POOL_TARGET_DESCRIPTION, defaultValue = TARGET_FILTER_DAANSE_IDENT)
    default String connectionPool_target() {
